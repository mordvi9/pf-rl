...
from agents.pf_drq_agent import PFDRQAgent
...
def main(cfg: DictConfig):
    ...
    pf_rq_agent = PFDRQAgent(input_dim = 4, action_dim = 4, seq_len = cfg.seq_len, lr=cfg.p_lr, gamma=cfg.p_gamma, epsilon=cfg.p_epsilon, epsilon_decay=cfg.p_epsilon_decay, epsilon_min=cfg.p_epsilon_min, buffer_size=cfg.p_buffer_size)
    agent = drqn_agent
    pf = None
    type = "drqn"
    #type = "pf"
